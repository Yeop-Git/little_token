...
const ROWS: Row[] = [
  ...
  ['영감','Inspiration','ひらめき','Вдохновение','灵感','靈感'], ['이번 전투','This battle','今回の戦闘','Этот бой','本场战斗','本場戰鬥'], ['보상','Reward','報酬','Награда','奖励','獎勵'], ['주인공 상태','Hero status','主人公の状態','Состояние героя','主角状态','主角狀態'],
