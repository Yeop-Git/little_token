...
const ROWS: Row[] = [
  ...
  ['거미줄 봉인 · 이번 문장에는 선택할 수 없다','Web-sealed · cannot be chosen for this sentence','蜘蛛の糸で封印 · 今回の文では選べない','Запечатано паутиной · нельзя выбрать для этой фразы','蛛网封印 · 本句无法选择','蛛網封印 · 本句無法選擇'], ['선택 불가','Unavailable','選択不可','Недоступно','无法选择','無法選擇'], ['잉크 최대 10 초과','Exceeds Ink maximum 10','インク上限10を超える','Превышает предел чернил 10','超过墨水上限10','超過墨水上限10'], ['맥락 충돌','Context conflict','文脈の矛盾','Конфликт контекста','语境冲突','語境衝突'], ['이번 전투 소진','Spent this battle','この戦闘では使用済み','Исчерпано в этом бою','本场战斗已耗尽','本場戰鬥已耗盡'], ['손패 가득','Hand full','手札がいっぱい','Рука заполнена','手牌已满','手牌已滿'], ['남은 카드 없음','No cards left','残りカードなし','Карт не осталось','没有剩余卡牌','沒有剩餘卡牌'], ['남은 뽑기','Draws left','残りドロー','Осталось доборов','剩余抽卡','剩餘抽卡'], ['회 남음',' left','回残り',' осталось','次','次'], ['회남음',' left','回残り',' осталось','次','次'], ['등과',' and others','などと',' и другими','等','等'], ['함께','together','一緒に','вместе','一起','一起'],
  ['잉크 비용','Ink cost','インクコスト','Стоимость чернил','墨水费用','墨水費用'], ['잉크','Ink','インク','Чернила','墨水','墨水'],
  ['현재 잉크 한도 초과','Exceeds currently available Ink','現在使えるインクの上限を超える','Превышает доступный запас чернил','超过当前可用墨水上限','超過目前可用墨水上限'], ['남은 문장을 완성할 잉크 부족','Not enough Ink to finish the remaining sentence','残りの文を完成させるインクが足りない','Недостаточно чернил для завершения фразы','墨水不足以完成剩余句子','墨水不足以完成剩餘句子'],
  ['주어 선택으로 되돌리기','Return to Subject selection','主語選択に戻る','Вернуться к выбору подлежащего','返回主语选择','返回主語選擇'], ['수식 선택으로 되돌리기','Return to Modifier selection','修飾語選択に戻る','Вернуться к выбору модификатора','返回修饰语选择','返回修飾語選擇'], ['동사 선택으로 되돌리기','Return to Verb selection','動詞選択に戻る','Вернуться к выбору глагола','返回动词选择','返回動詞選擇'],
  ['기본 6, 남은 잉크 이월 최대 2, 체력 초과 집필 최대 2로 한 문장은 최대 10까지 쓴다.','Start with 6 Ink, carry up to 2 unused Ink, and overdraw up to 2 Health for a sentence maximum of 10.','基本インク6、繰越最大2、体力での超過執筆最大2で、一文につき最大10まで使える。','Базово даётся 6 чернил, до 2 переносятся, ещё до 2 оплачиваются здоровьем: максимум 10 на фразу.','基础墨水6，最多结转2，再以体力超写2，一句话最多使用10。','基礎墨水6，最多結轉2，再以體力超寫2，一句話最多使用10。'],
  ['카드를 클릭하면 그 칸이 곧바로 확정된다. 아래 단계 버튼을 누르면 그 칸으로 돌아가 뒤 선택을 다시 고를 수 있다.','Clicking a card confirms that slot immediately. Use a step button below to return there and choose the later cards again.','カードをクリックするとその枠が即座に確定する。下の段階ボタンでその枠に戻り、後の選択をやり直せる。','Щелчок по карте сразу подтверждает слот. Кнопка этапа внизу возвращает к нему и позволяет заново выбрать последующие карты.','点击卡牌会立即确认该栏。点击下方阶段按钮可返回该栏并重新选择之后的卡牌。','點擊卡牌會立即確認該欄。點擊下方階段按鈕可返回該欄並重新選擇之後的卡牌。'],
]
