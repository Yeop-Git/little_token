...
const UI: Record<Exclude<LocaleCode, 'ko'>, UiDictionary> = {
  en: {
    ...
    rewardAcquireReinforce: 'Reinforce +1', rewardAcquireItem: 'New item', rewardAcquireWord: 'New word', rewardCurrencyInspiration: 'Run · Inspiration',
  ...
  ja: {
    ...
    rewardAcquireReinforce: '反復強化 +1', rewardAcquireItem: '新アイテム', rewardAcquireWord: '新しい言葉', rewardCurrencyInspiration: 'ラン · ひらめき',
  ...
  ru: {
    ...
    rewardAcquireReinforce: 'Усиление +1', rewardAcquireItem: 'Новый предмет', rewardAcquireWord: 'Новое слово', rewardCurrencyInspiration: 'Забег · Вдохновение',
  ...
  'zh-Hans': {
    ...
    rewardAcquireReinforce: '重复强化 +1', rewardAcquireItem: '新道具', rewardAcquireWord: '新单词', rewardCurrencyInspiration: '本轮 · 灵感',
  ...
  'zh-Hant': {
    ...
    rewardAcquireReinforce: '重複強化 +1', rewardAcquireItem: '新道具', rewardAcquireWord: '新單詞', rewardCurrencyInspiration: '本輪 · 靈感',
