...
const UI: Record<Exclude<LocaleCode, 'ko'>, UiDictionary> = {
  en: {
    ...
    hudClearRewardTip: 'Clear reward +{value}\nExpected Inspiration. It falls in long battles and rises when you sweep a turn.',
    ...
    hudHomeTip: 'Home\nLeave the battle and return to the title screen.',
  ...
  ja: {
    ...
    hudClearRewardTip: 'クリア報酬 +{value}\n獲得予定のひらめき。長期戦で減り、1ターンで一掃すると増える。',
  ...
  ru: {
    ...
    hudClearRewardTip: 'Награда за победу: +{value}\nОжидаемое вдохновение: уменьшается в долгом бою и растёт за зачистку за ход.',
    ...
    hudHomeTip: 'Домой\nПокинуть бой и вернуться на титульный экран.',
