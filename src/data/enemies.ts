...
export const ENEMIES: Record<string, EnemyDef> = {
  ...
  queenBee: {
    ...
    note: '3턴마다 공격하며, 매 턴 시작에 좌우를 번갈아 일벌 한 마리를 불러 최대 4마리의 호위를 만든다. 일벌마다 공격이 +0.5 되고, 넷이 모이면 다음 공격에 모두 돌격한 뒤 호위가 비워진다. 단일·2명·3명 공격은 각각 일벌 1·2·3마리를, 전체 공격은 전부 흩어 낸다.',
  },
  elderSpider: {
