...
export const SPECIAL_REWARD_WORDS: Word[] = [
  ...
  { id: 'storedResolve', text: '버틴 힘을 내질렀다', slot: 'verb', tags: ['guard', 'atk'], emotion: 'anger', stat: 'atk', statMult: 0, kind: 'attack', targetCount: 2, effects: { guardAttackMultiplier: 0.9 }, art: '3009', rarity: 'rare', note: '2명(100%·70%) · 현재 방어도 피해 90%', lore: '지워지지 않고 남은 문장이 단단한 힘이 되어 튀어나간다.' },
  { id: 'overflowingHeart', text: '넘친 마음을 건넸다', slot: 'verb', tags: ['mend', 'joy'], emotion: 'joy', stat: 'heal', statMult: 1.25, kind: 'heal', effects: { overhealDamageMultiplier: 1 }, art: '3019', rarity: 'rare', note: '회복 ×1.25 · 초과 회복 피해 100%', lore: '내게 다 담지 못한 온기가 벌레를 밀어낸다.' },
  ...
  { id: 'dampenMomentum', text: '기세를 눌러 적었다', slot: 'verb', tags: ['debuff', 'hold'], emotion: 'joy', stat: 'atk', statMult: 0.5, kind: 'attack', effects: { enemyAttackDown: 4 }, art: '3012', rarity: 'rare', note: '공격 ×0.5 · 다음 적 공격 −4', lore: '거칠어진 이야기를 손바닥으로 눌러 천천히 만든다.' },
  { id: 'readAhead', text: '앞줄을 미리 읽었다', slot: 'verb', tags: ['focus', 'calm'], emotion: 'pleasure', stat: 'guard', statMult: 0.75, kind: 'guard', effects: { drawCards: 1 }, art: '3011', rarity: 'common', note: '방어 ×0.75 · 다음 첫 손패 +1', lore: '다음에 올 단어를 알아보자 마음이 조금 느긋해졌다.' },
]
