...
export const SPECIAL_REWARD_WORDS: Word[] = [
  ...
  { id: 'pourThree', text: '쏟아냈다', slot: 'verb', tags: ['wide', 'tear'], emotion: 'sorrow', stat: 'atk', statMult: 0.8, kind: 'attack', targetCount: 3, art: '3014', rarity: 'epic', note: '공격 ×0.8 · 3명(100%·70%·50%)', lore: '참았던 잉크가 한꺼번에 쏟아진다.' },
  { id: 'doubleTap', text: '두드렸다', slot: 'verb', tags: ['hit', 'atk'], emotion: 'anger', stat: 'atk', statMult: 0.65, kind: 'attack', targetCount: 1, effects: { hitCount: 2 }, art: '3015', rarity: 'common', note: '공격 ×0.65 · 2연타', lore: '똑, 똑. 실드가 먼저 금이 간다.' },
  ...
  { id: 'tearMend', text: '울음을 삼켰다', slot: 'verb', tags: ['mend', 'tear'], emotion: 'sorrow', stat: 'heal', statMult: 1.1, kind: 'heal', art: '3019', rarity: 'rare', note: '회복 ×1.1', lore: '젖은 종이를 꼭 눌러 펴고 다시 쓴다.' },
  { id: 'riseAgain', text: '이를 악물고 일어섰다', slot: 'verb', tags: ['mend', 'grit'], emotion: 'anger', stat: 'heal', statMult: 0.9, kind: 'heal', art: '3020', rarity: 'rare', note: '회복 ×0.9', lore: '화난 마음도 다음 줄을 쓸 힘이 된다.' },
]
