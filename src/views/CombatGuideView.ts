        ...
        <article class="guide-paper" aria-labelledby="guide-title">
          ...
          <section class="guide-grid">
            ...
            <div class="guide-block">
              ...
              <h2>5. 방어와 타격</h2>
              <p><b>체력과 방어막은 다음 스테이지에도 유지</b>된다. 방어막은 피해를 먼저 받고 최대 체력만큼 비축할 수 있으며, <b>관통</b>은 이를 무시하고 방어막도 깎지 않는다. <b>매직실드</b>는 한 타격을 완전히 막고 1겹을 소비한다. 관통도 매직실드는 넘지 못하므로 <b>연타</b>로 먼저 벗길 수 있다.</p>
            </div>
          </section>
