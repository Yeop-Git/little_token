...
클리어 보상은 **주어 → 수식어·아이템 → 동사**의 3단계 3택이다. 가운데 보상은
수식어와 아이템을 최소 한 장씩 포함해 어느 한 종류로 몰리지 않는다.
...
매 사이클 10층의 가운데 보상에는 전설 규칙 아이템을, 15층의 동사 보상에는 전설
스킬카드를 최소 한 장 넣어 플레이어가 각각 하나 이상 선택할 기회를 보장한다.
미획득 전설 아이템이 있으면 이미 얻은 전설보다 우선한다.

보스 클리어는 구간 상승을 눈에 보이게 확정한다. 5층은 희귀, 10층은 영웅,
15층은 전설 스킬카드를 주어·수식어/아이템·동사의 각 보상에 최소 한 장씩 둔다.
현재 아이템 등급은 노멀·전설 두 축뿐이므로 세 선택지 전체의 등급을 강제로
통일하지 않고, 대표 등급 카드 한 장을 고정해 아이템 선택과 카드 다양성을 보존한다.
